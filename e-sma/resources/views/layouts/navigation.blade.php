<aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
    <div class="py-4 text-gray-500">
        ...
        <img src="{{ asset('images/E-SMA.png') }}" alt="Logo" class="w-10 h-10 mx-auto mb-4" width="100px">
        </a>
        ...
        <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('addPengajar') }}" :active="request()->routeIs('addJadwal')">
                    <x-slot name="icon">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                    </svg>
            ...
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('pilihMapel') }}" :active="request()->routeIs('addNilai')">
                    <x-slot name="icon">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                    </svg>
